    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src","files":"**/*.stories.jsx","importPathMatcher":"^\\.[\\\\/](?:src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.jsx)$"}];
      ...
      import './runtime~main.49aa3ffd.iframe.bundle.js';
      
      import './777.1300b463.iframe.bundle.js';
      
      import './main.1e0c6994.iframe.bundle.js';</script></body></html>